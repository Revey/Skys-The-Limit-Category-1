  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00aeef] rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6 animate-fade-in-up">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-32 h-32 flex items-center justify-center">
            <span className="text-5xl font-bold text-[#00aeef]">C9</span>
          </div>
        </div>

        {/* Title */}
        <p className="text-xs uppercase tracking-[0.3em] text-[#00aeef] mb-4">Cloud9 Valorant</p>
        ...
        <div className="mt-20 grid grid-cols-3 gap-8 max-w-lg mx-auto opacity-60">
          <div className="text-center">
            <div className="text-3xl font-bold text-[#00aeef]">212</div>
